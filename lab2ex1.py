...
print(delta2)
print(delta3)
print(f'Vectorization time / Loop time for n = {n} repeat {repeat} times: {delta2 / delta1}')
print(f'Numba time / Loop time for n = {n} repeat {repeat} times: {delta3 / delta1}')
